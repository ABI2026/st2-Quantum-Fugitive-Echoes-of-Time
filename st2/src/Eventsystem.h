...
public:
	...
	void set_key_callback(sf::Keyboard::Key key, std::function<void(sf::Keyboard::Key, int)>);

	void add_mouse_listener(sf::Mouse::Button button);
	bool get_mouse_event(sf::Mouse::Button button);
	void set_mouse_callback(sf::Mouse::Button button, std::function<void(sf::Mouse::Button, int)>);
